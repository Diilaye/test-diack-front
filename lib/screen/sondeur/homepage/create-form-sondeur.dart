...
import 'package:form/screen/sondeur/components/questions/address-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/date-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/email-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/explanation-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/file-field-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/full-name-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/image-field-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/multi-selection-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/separator-field-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/separator-field-with-title-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/single-selection-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/telephone-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/textArea-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/textField-Form-modern.dart';
import 'package:form/screen/sondeur/components/questions/yes-or-no-Form-modern.dart';
...
class _CreateFormSondeurScreenState extends State<CreateFormSondeurScreen>
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Glissez et déposez les éléments ci-dessous pour construire votre formulaire",
                  style: TextStyle(
                    fontSize: 12,
                    color: Colors.grey.shade600,
                    height: 1.4,
          ...
          AnimatedContainer(
            ...
            child: Column(
              children: [
                _buildModernSection(
                  title: "Éléments essentiels",
                  subtitle: "Questions de base pour votre formulaire",
                  icon: "text-fields",
                  color: Colors.blue,
                  child: const EssentielSectionMenu(),
                ),
                const SizedBox(height: 24),
                _buildModernSection(
                  title: "Informations de contact",
                  subtitle: "Collectez les coordonnées de vos utilisateurs",
                  icon: "person",
                  color: Colors.green,
                  child: const ContactSectionMenu(),
                ),
                const SizedBox(height: 24),
                _buildModernSection(
                  title: "Téléchargement & Médias",
                  subtitle: "Permettez l'upload de fichiers et images",
                  icon: "file-plus",
                  color: Colors.purple,
                  child: const TelechargementSectionMenu(),
                ),
                const SizedBox(height: 24),
                _buildModernSection(
                  title: "Structure & Mise en page",
                  subtitle: "Organisez et structurez votre formulaire",
                  icon: "separator",
                  color: Colors.orange,
                  child: const MediaStructureSectionMenu(),
                ),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  "Commencez par les questions essentielles, puis ajoutez les informations de contact et les éléments de structure selon vos besoins.",
  ...
  Widget _buildQuestionWidget(dynamic champ) {
    ...
    switch (champ.type!) {
      case 'textField':
        questionWidget = TextFieldFormModern(champ: champ);
        break;
      case "textArea":
        questionWidget = TextAreaFormModern(champ: champ);
        break;
      case "singleChoice":
        questionWidget = SingleSelectionFormModern(champ: champ);
        break;
      case "yesno":
        questionWidget = YesOrNoFormModern(champ: champ);
        break;
      case "multiChoice":
        questionWidget = MultiSelectionFormModern(champ: champ);
        break;
      case "nomComplet":
        questionWidget = FullNameFormModern(champ: champ);
        break;
      case "email":
        questionWidget = EmailFormModern(champ: champ);
        break;
      case "addresse":
        questionWidget = AddressFormModern(champ: champ);
        break;
      case "telephone":
        questionWidget = TelephoneFormModern(champ: champ);
        break;
      case "image":
        questionWidget = ImageFieldFormModern(champ: champ);
        break;
      case "file":
        questionWidget = FileFieldFormModern(champ: champ);
        break;
      case "separator":
        questionWidget = SeparatorFieldFormModern(champ: champ);
        break;
      case "separator-title":
        questionWidget = SeparatorFieldWithTitleFormModern(champ: champ);
        break;
      case "explication":
        questionWidget = ExplanationFormModern(champ: champ);
        break;
      case "date":
        questionWidget = DateFieldFormModern(champ: champ);
        break;
      default:
        questionWidget = Container();
    }

    // Tous les nouveaux composants modernes gèrent déjà leur propre styling
    // Pas besoin du conteneur externe
