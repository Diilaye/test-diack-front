...
class MediaStructureSectionMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        ..._buildStructureFields(formulaireSondeur),
      ],
    );
  }

  List<Widget> _buildStructureFields(FormulaireSondeurBloc formulaireSondeur) {
    final fields = [
      {
        'text': 'Séparateur',
        'subtitle': 'Ligne de séparation',
        'iconData': 'assets/images/separator.svg',
        'color': const Color(0xFF10B981),
        'onpress': () async {
          formulaireSondeur.addChampFormulaireType(
              formulaireSondeur.formulaireSondeurModel!.id!, "separator");
        },
      },
      {
        'text': 'Séparateur avec titre',
        'subtitle': 'Section avec titre',
        'iconData': 'assets/images/text-size.svg',
