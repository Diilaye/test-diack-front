...
class FileFieldForm extends StatefulWidget {
  final ChampsFormulaireModel champ;

  const FileFieldForm({super.key, required this.champ});

  @override
  State<FileFieldForm> createState() => _FileFieldFormState();
}

class _FileFieldFormState extends State<FileFieldForm> {
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: const InputDecoration(
                            ...
                            hintText: "Téléchargez vos fichiers ici ?"),
                      ),
                    ),
                    paddingHorizontalGlobal(8),
                  ],
