...
class TextFieldForm extends StatefulWidget {
  ...
  const TextFieldForm({super.key, required this.champ});
                ...
                if (isOpenSetting)
                  Column(
                    children: [
                      ...
                      paddingVerticalGlobal(),
                      if (widget.champ.haveResponse == '1' ? true : false)
                        Row(
                          children: [
                            paddingHorizontalGlobal(8),
                            Expanded(
                              child: TextField(
                                controller: widget.champ.haveResponse == '0'
                                    ? TextEditingController()
                                    : TextEditingController()
                                  ..text = widget.champ.listeReponses!.length >
                                          0
                                      ? "${widget.champ.listeReponses![0].option}"
                                      : "Réponse par default",
                                onSubmitted: (v) => formulaireSondeurBloc
                                    .addChampFormulaireResponseTextField(
                                        widget.champ.id!, makeId(20), v),
                                style: TextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.bold,
                                    color: noir),
