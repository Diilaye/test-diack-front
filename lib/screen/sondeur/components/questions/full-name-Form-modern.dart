...
class FullNameFormModern extends StatefulWidget {
  final ChampsFormulaireModel champ;

  const FullNameFormModern({super.key, required this.champ});

  @override
  State<FullNameFormModern> createState() => _FullNameFormModernState();
}

class _FullNameFormModernState extends State<FullNameFormModern>
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _buildPreviewField('Prénom'),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _buildPreviewField('Nom'),
              ),
            ],
          ),
        ],
