...
class EditAnneeAcademiqueScreen extends StatefulWidget {
  const EditAnneeAcademiqueScreen({super.key});

  @override
  State<EditAnneeAcademiqueScreen> createState() =>
      _EditAnneeAcademiqueScreenState();
}

class _EditAnneeAcademiqueScreenState extends State<EditAnneeAcademiqueScreen> {
  @override
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          anneeAcademiqueBloc.updateAnneAcademique();
                          adminBloc.setMenu(0);
                        },
                        child: Container(
                          height: 50,
