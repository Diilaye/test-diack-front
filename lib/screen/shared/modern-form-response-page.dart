...
import 'package:form/models/liste-options-model.dart';
...
class ModernFormResponsePage extends StatefulWidget {
  final String shareId;
  final FormulaireSondeurModel? formulaire;
  final bool requirePassword;

  const ModernFormResponsePage({
    Key? key,
  ...
  @override
  State<ModernFormResponsePage> createState() => _ModernFormResponsePageState();
}

class _ModernFormResponsePageState extends State<ModernFormResponsePage>
  ...
  List<ChampsFormulaireModel> _createTestChamps() {
    return [
      ...
      ChampsFormulaireModel(
        ...
        formulaire: 'test-form-123',
        listeOptions: [
          ListeOptions(id: 'opt-1', option: 'Excellent'),
          ListeOptions(id: 'opt-2', option: 'Très bon'),
          ListeOptions(id: 'opt-3', option: 'Bon'),
          ListeOptions(id: 'opt-4', option: 'Moyen'),
          ListeOptions(id: 'opt-5', option: 'Mauvais'),
        ],
      ),
      ChampsFormulaireModel(
        id: 'champ-4',
        ...
        children: [
          ...champsForPage.map((champ) => Container(
                ...
                child: FormResponseField(
                  ...
                  initialValue: _responses[champ.id],
                ),
              )),
        ],
      ),
